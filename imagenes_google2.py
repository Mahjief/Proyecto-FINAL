...
searchword1 = 'salay+danza+bolivian'
searchurl = 'https://www.google.com/search?q=' + searchword1 + '&source=lnms&tbm=isch'
dirs = 'pictures/salay' 
maxcount = 1000

chromedriver = 'C:\\Users\\Mahjief\\Desktop\\chromedriver.exe'
...
def download_google_staticimages():
    ...
    browser.find_element_by_xpath('//input[@value="Mostrar más resultados"]').click()
